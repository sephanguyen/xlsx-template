...
export default class Workbook {
  ...
  public generate<T extends Buffer | Uint8Array | Blob | string | ArrayBuffer>(
  ...
  protected loadSheets(
    prefix: any,
    workbook: etree.ElementTree,
    workbookRels: any
  ): any[];
  protected loadSheet(
    sheet: any
  ): { filename: any; name: any; id: any; root: any }; // this could definitely return a "Sheet" interface/class
  ...
  protected splitRef(
    ref: any
  ): { table: any; colAbsolute: any; col: any; rowAbsolute: any; row: any };
  ...
  protected substituteTable(
    ...
    key: any,
    placeholder: TemplatePlaceholder,
    drawing: etree.ElementTree
  ): any;
  protected substituteImage(
    cell: any,
    string: string,
    placeholder: TemplatePlaceholder,
    substitution: any,
  ...
  protected getWidthMergeCell(
    mergeCell: etree.ElementTree,
    sheet: etree.ElementTree
  ): Float32Array;
  protected getHeightCell(numRow: number, sheet: etree.ElementTree): number;
  protected getHeightMergeCell(
    mergeCell: etree.ElementTree,
    sheet: etree.ElementTree
  ): Float32Array;
  ...
  protected cellInMergeCells(
    cell: etree.ElementTree,
    mergeCell: etree.ElementTree
  ): boolean;
